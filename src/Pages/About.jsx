...
function About() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center px-2">
      ...
      <div>
        <div className="ml-30 text-white max-w-md" data-aos="fade-left">
          <h2 className="flex flex-wrap gap-2 text-3xl font-bold">
          ...
          <p className="mt-4 text-sm text-gray-400">
            My mission: Create incredible digital experiences, always learning
            and evolving to offer the best solutions.
            ...
            in Human Resources Management. However, my passion for programming
            has always been with me, driving me to pursue personal projects in
            parallel. With careful financial planning, I made a plan to return
            to my field of study, seeking to fulfill my dream of building a
            solid career in software development.
          </p>
          <div>
            ...
            <div className="mt-4 text-sm text-gray-400 flex flex-wrap gap-3">
              {[
                {
                  title: "Front-End",
                  items: [
                ...
                <div
                  key={index}
                  className="shadow-xs shadow-gray-400 border border-gray-500 rounded-xl p-3 w-44 cursor-pointer items-center justify-center transition-colors duration-500 hover:bg-gray-500 hover:text-black"
